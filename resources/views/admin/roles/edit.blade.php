{{--
    Role Edit View
    Edits existing role with permissions management
                ...
                <div class="card-header bg-dark border-secondary">
                    <div class="d-flex justify-content-between align-items-center">
                        <h5 class="card-title mb-0 text-light">
                            <i class="fas fa-edit me-2"></i>Role Information
                        </h5>
                        <div class="d-flex align-items-center">
                            <span class="badge bg-{{ $role->is_active ? 'success' : 'danger' }} me-2">
                    ...
                    <form action="{{ route('admin.roles.update', $role) }}" method="POST" id="roleForm">
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-6">
                                <div class="mb-3">
                                    ...
                                    <input type="text" class="form-control bg-dark border-secondary text-light"
                                           id="slug" name="slug" value="{{ old('slug', $role->slug) }}" readonly
                            ...
                            <div class="col-md-6">
                                <div class="mb-3">
                                    ...
                                    <select class="form-select bg-dark border-secondary text-light"
                                        ...
                                        <option value="1" {{ old('level', $role->level) == '1' ? 'selected' : '' }}>Level 1 - Basic User</option>
                                        <option value="2" {{ old('level', $role->level) == '2' ? 'selected' : '' }}>Level 2 - Advanced User</option>
                                        <option value="3" {{ old('level', $role->level) == '3' ? 'selected' : '' }}>Level 3 - Supervisor</option>
                                        <option value="4" {{ old('level', $role->level) == '4' ? 'selected' : '' }}>Level 4 - Manager</option>
                                        <option value="5" {{ old('level', $role->level) == '5' ? 'selected' : '' }}>Level 5 - Administrator</option>
                                    </select>
                                    <div class="form-text text-muted">
                        ...
                        <div class="row">
                            <div class="col-md-4">
                                <div class="card bg-secondary border-0">
                                    <div class="card-body text-center">
                                        <h4 class="text-light">{{ $role->users()->count() }}</h4>
                            ...
                            <div class="col-md-4">
                                <div class="card bg-secondary border-0">
                                    <div class="card-body text-center">
                                        <h4 class="text-light">{{ $role->permissions()->count() }}</h4>
                            ...
                            <div class="col-md-4">
                                <div class="card bg-secondary border-0">
                                    <div class="card-body text-center">
                                        <h4 class="text-light">{{ $role->created_at->diffForHumans() }}</h4>
            ...
            <div class="card bg-dark border-secondary mt-3">
                ...
                <div class="card-body">
                    <div class="d-grid gap-2">
                        <a href="{{ route('admin.roles.users', $role) }}" class="btn btn-outline-info btn-sm">
                            <i class="fas fa-users me-2"></i>Manage Users ({{ $role->users()->count() }})
                        </a>
                        <button type="button" class="btn btn-outline-warning btn-sm" onclick="duplicateRole()">
                            <i class="fas fa-copy me-2"></i>Duplicate Role
                        </button>
                        @if(!$role->users()->count())
                            <button type="button" class="btn btn-outline-danger btn-sm" onclick="deleteRole()">
                ...
                <div class="card-body">
                    <div class="d-flex justify-content-between align-items-center">
                        <div class="text-muted">
                            ...
                            Last updated: {{ $role->updated_at->format('M d, Y \a\t g:i A') }}
                            @if($role->updated_by)
                                by {{ $role->updatedByUser->name ?? 'System' }}
                            @endif
                        </div>
                        <div>
                            ...
                            <button type="submit" class="btn btn-warning" form="roleForm">
...
function duplicateRole() {
    if (confirm('Create a copy of this role with the same permissions?')) {
        // Create form to duplicate role
